# 2.1 Processing Services (Higher-Order Business Logic)
...
#### 2.1.2.0.2 Class-Level Language
...
### 2.1.2.3 Used-Data-Only Validations
...
#### 2.1.3.1.0 Non-Exception Local Models
