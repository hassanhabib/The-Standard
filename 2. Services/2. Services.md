...
We will discuss these aspects in detail in the upcoming chapter. The main thing to understand about services is to design to be pluggable and configurable, so they are easily integrated with any technology from a dependency standpoint and easily plugged into any exposure functionality from an API perspective.
