...
#### 1.7.2 If brokers were truely a layer of abstraction from the business logic, how come we allow external exceptions to leak through them onto the services layer?
...
[*] [Implementing Abstract Components (Brokers)](https://www.youtube.com/watch?v=8PveoymxCok)
