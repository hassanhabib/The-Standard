...
The Tri-Nature pattern could also be perceived at the lowest scale of any system as well as the highest scale. That's what we call a fractal pattern. Every system out there is infinitly comprised of three components, where each one of them has three components as well and so on.
